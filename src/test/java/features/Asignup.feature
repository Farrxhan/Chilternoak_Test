...
Feature: SignUp fuctionality
  ...
  Scenario Outline: To test the SigUp functionality of Chiltern Oak page
    ...
    Examples: 
      ...
      | User  | A     | zsera7997@gmail.com | User     | Password is too short (minimum is 5 characters) |
      | User  | A     |                     | User@123 | Please enter the valid data                     |
      | User  |       | zsera@gmail.com     | User     | Please enter the valid data                     |
      |       |       |                     |          | Emil and Password cant be bla                   |
      | User  | A     | zsera012@gmail.com  | User@123 | robot                                           |
